...
<head>
    ...
    <style>
        ...
        #sidebar {
            ...
            top: 0;
            left: 0;
            background: linear-gradient(180deg, var(--sidebar-bg), #000066);
        ...
        <div class="p-3">
            <div class="d-flex align-items-center gap-3 animate__animated animate__fadeIn">
                <img src="https://placehold.co/40" class="rounded-circle user-avatar" alt="Profile"
                    style="width: 40px; height: 40px; border: 2px solid var(--accent-color);">
                <div class="user-info">
                    <h6 class="mb-0">Asibur Rahman</h6>
                    <small class="text-accent">Administrator</small>
                </div>
            </div>
        </div>
        <nav>
